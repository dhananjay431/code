...
angular.module('App.tmProcessSubmission', ['ui.router', 'ngAnimate', 'ngSanitize', 'ui.bootstrap', 'ngFileUpload']).config(function ($stateProvider, $urlRouterProvider, $locationProvider) {
  ...
  setTimeout(function () {
   // $(".listofpartscombined").dashboardCodeBsMultiSelect();
  }, 500);
});