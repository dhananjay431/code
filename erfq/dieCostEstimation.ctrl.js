            ...
            $.cordys.ajax({
                ...
                success: function success(e) {
                    ...
                    if (prevData.length == 0) {
                        vm.data = { "PROJECT_CODE": $scope.data.projDetails.PROJECT_CODE, "ERFQ_NUMBER": $scope.data.projDetails.ERFQ_NUMBER, "PART_NUMBER": $scope.data.rowDetails.PART_NUMBER, "PART_NAME": $scope.data.rowDetails.NOMENCLATURE, "OP_NUMBER": "", "OP_NAME": "", "TOOL_SIZE_L_TO_R": "", "TOOL_SIZE_F_TO_B": "", "TOOL_SIZE_SH": "", "TOOL_WEIGHT": "", "DIE_CFQTY": "", "SIMULATION_HR": "", "SIMULATION_COST": "", "DIE_DESIGN_HRS": "", "DIE_DESIGN_COST": "", "CNC_PROGRAM_COST": "", "CNC_PROGRAM_HRS": "", "CASTING_WEIGHT": "", "TOOL_STEEL_WEIGHT": "", "RAW_MATERIAL_INCL_CASTING": "", "MATERIAL_COST_STD_ITEMS": "", "MACHINING_HRS": "", "MACHINING_COST": "", "ASSY_FINISHING_HRS": "", "ASSY_FINISHING_COST": "", "TRYOUT_HRS": "", "TRYOUT_COST": "", "TOTAL_MANUFACTURING_COST": "", "FOB_CHARGE": "", "FOB_TOTAL": "", "ESTIMATED_TONNAGE": "", "SPM_COMMITTED": "", "YIELD": "", "EST_BANK": "", "NO_OF_DIES": "", "NO_OF_CHECKING_FIXTURE": "", "TOTAL_WEIGHT": "", "COST_TON": "", "TOTAL_COST": "", "NO_OF_PARTS": "", "DIE_COST_ROW_NUM": "", "DIE_COST_REVISION": 1 };
                        // start 
                        ...
                        // start 
                        if ($scope.roles != "MSIE")
                           if($scope.ERFQ_PROCESS_PARTS[0].DIE_COST_STATUS != "saved"){
                            for (var i = 0; i < (14); i++) {
