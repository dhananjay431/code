  ...
  $scope.gridOptions2 = {
    ...
    columnDefs: [{
      ...
      cellEditorSelector: function cellEditorSelector(params) {
		...
		cellRenderer: function cellRenderer(params) {
			if (params.data.NO_OF_DIES_BLANKINGDIE == "Excluded") return (params.data.EX_DIES_BUDGETED);
			else return (params.data.IN_DIES_BUDGETED);
		}
    }],
    components: {
...
/*Export to Csv Function given below.*/
  $scope.xl = function () {
    var params = {
      "skipHeader": false,
      "columnGroups": true,
  ...
  /*Export to Csv Functio is Ended*/
